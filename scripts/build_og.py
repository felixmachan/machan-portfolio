...
.visual{{position:absolute;right:64px;top:64px;width:{vw}px;height:{vh}px;border:1.5px solid #383b40;background:#fbfbf9;padding:10px;overflow:hidden}}
...
def main():
    ...
    for slug, dwg, domain, title, subtitle, visual, mode in CARDS:
        ...
        html = TEMPLATE.format(fonts=f"{assets}/fonts", dwg=dwg, domain=domain, title=title,
                               ...
                               vh=440, fit="cover" if mode == "cover" else "contain")
